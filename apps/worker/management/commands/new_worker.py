                ...
                for event in states:
                    ...
                    if serialized_data['callback_data']:
                        try:
                            ...
                            print('Нет привязанного сообщения!', e)
                    ...
                    #Текст
                        ...
                        try:
                            ...
                            try:
                                command = Bot_Commands.objects.filter(text=message_text.split(' ')[0])
                            except:
                            ...
                            if command.exists():
                                ...
                                elif user.state == "referal_completed":
                                    state = Bot_Message.objects.get(current_state=user.state)
                                    if state.handler:
                                        handler_name = state.handler
                                    else:
